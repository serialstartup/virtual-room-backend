...
export class TokenController {
    ...
    static async purchaseTokens(req, res) {
        try {
            ...
            const transaction = await TokenService.creditTokens(userId, amount, `Token package purchase: ${package_type}`, 'purchase');
     ...
     */
    static async getTokenPackages(req, res) {
        try {
     ...
     */
    static async getTokenCosts(req, res) {
        try {
            const costs = {
     ...
     */
    static async adminCreditTokens(req, res) {
        try {
            ...
            const transaction = await TokenService.creditTokens(target_user_id, amount, description || 'Admin credit', 'credit');
