...
export class DownloadController {
    ...
    static async getDownloadInfo(req, res) {
        ...
        try {
            ...
            const downloadInfo = await DownloadService.getImageInfo(image_url, workflow_type);
    ...
    static async getDownloadUrl(req, res) {
        ...
        try {
            ...
            const downloadUrl = await DownloadService.getDownloadUrl(image_url, workflow_type);
    ...
    static async logDownload(req, res) {
        ...
        try {
            ...
            await DownloadService.logDownload(userId, try_on_id, workflow_type, image_url);
    ...
    static async checkDownloadPermissions(req, res) {
        const requestId = Math.random().toString(36).substring(7);
