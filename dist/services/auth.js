...
export class AuthService {
    ...
    static async signup(userData, acceptLanguage) {
        try {
    ...
    static async createDefaultUserSettings(userId, acceptLanguage) {
        try {
    ...
    static async createDefaultUserStats(userId) {
        try {
    ...
    static async login(credentials) {
        try {
            ...
            const userWithPassword = data;
            const isValidPassword = await this.verifyPassword(credentials.password, userWithPassword.password_hash);
            if (!isValidPassword) {
                throw new Error("Email veya şifre hatalı");
            }
    ...
    static async createDefaultUserSettingsForExistingUser(userId) {
