...
export const wardrobeService = {
    async addToWardrobe(userId, tryOnId, liked) {
        try {
    ...
    async updateWardrobeItem(userId, tryOnId, updates) {
        try {
            validateUserId(userId);
            const { data, error } = await supabase
                .from('wardrobe')
    ...
    async removeFromWardrobe(userId, tryOnId) {
        try {
            validateUserId(userId);
    ...
    async getWardrobe(userId, filter) {
        try {
            validateUserId(userId);
            let query = supabase
                .from('wardrobe')
    ...
    async toggleLike(userId, tryOnId) {
        try {
            validateUserId(userId);
    ...
    async toggleDislike(userId, tryOnId) {
        try {
            validateUserId(userId);
            const { data: current } = await supabase
                .from('wardrobe')
