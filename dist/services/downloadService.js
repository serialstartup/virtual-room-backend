export class DownloadService {
    ...
    static generateFilename(workflowType) {
    ...
    static async getImageInfo(imageUrl, workflowType) {
        try {
    ...
    static async getDownloadUrl(imageUrl, workflowType) {
        try {
            if (!this.isValidImageUrl(imageUrl)) {
                throw new Error('Invalid image URL');
            }
    ...
    static async logDownload(userId, tryOnId, workflowType, imageUrl) {
        try {
    ...
    static async canUserDownload(userId, tryOnId) {
        try {
