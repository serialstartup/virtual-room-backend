...
export const userModelService = {
  async createUserModel(userId: string, data: CreateUserModelRequest): Promise<UserModel> {
    try {
  ...
  async getUserModelById(userId: string, modelId: string): Promise<UserModel> {
    try {
      validateUserId(userId)
  ...
  async updateUserModel(userId: string, modelId: string, updates: UpdateUserModelRequest): Promise<UserModel> {
    try {
      validateUserId(userId)
  ...
  async deleteUserModel(userId: string, modelId: string): Promise<void> {
    try {
      validateUserId(userId)
  ...
  async findModelByFashionAIRequestId(requestId: string): Promise<UserModel | null> {
    try {
