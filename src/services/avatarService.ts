...
export const avatarService = {
  async createAvatar(userId: string, data: CreateUserAvatarRequest): Promise<UserAvatar> {
    try {
  ...
  async getAvatarById(userId: string, avatarId: string): Promise<UserAvatar> {
    try {
      validateUserId(userId)
  ...
  async updateAvatar(userId: string, avatarId: string, updates: UpdateUserAvatarRequest): Promise<UserAvatar> {
    try {
      validateUserId(userId)
  ...
  async getPrimaryAvatar(userId: string): Promise<UserAvatar | null> {
    try {
      validateUserId(userId)
  ...
  async setPrimaryAvatar(userId: string, avatarId: string): Promise<UserAvatar> {
    try {
      validateUserId(userId)
  ...
  async findAvatarByFashionAIRequestId(requestId: string): Promise<UserAvatar | null> {
    try {
