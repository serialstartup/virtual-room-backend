...
import { FeedbackService, type WorkflowType, type FeedbackType, type FeedbackSource } from "../services/feedbackService.js";
...
export class FeedbackController {
  ...
  static async getFeedback(req: AuthenticatedRequest, res: Response): Promise<void> {
  ...
  static async setFeedback(req: AuthenticatedRequest, res: Response): Promise<void> {
    const requestId = Math.random().toString(36).substring(7);
    ...
    try {
      ...
      const feedback = await FeedbackService.setFeedback(
        userId,
        try_on_id,
        try_on_type as WorkflowType,
  ...
  // Remove feedback
  static async removeFeedback(req: AuthenticatedRequest, res: Response): Promise<void> {
    const requestId = Math.random().toString(36).substring(7);
  ...
  static async getUserFeedbackStats(req: AuthenticatedRequest, res: Response): Promise<void> {
    const requestId = Math.random().toString(36).substring(7);
